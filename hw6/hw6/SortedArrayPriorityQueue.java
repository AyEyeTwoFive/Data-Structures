...
/**
 * Max priority queue implemented as a sorted ArrayList.
 *
...
public class SortedArrayPriorityQueue<T extends Comparable<? super T>>
    ...
    public SortedArrayPriorityQueue(Comparator<T> cmp) {
        ...
        this.data.add(null);  // "sentinel" spot
        this.cmp = cmp;
    }
    ...
    public boolean empty() {
        return this.data.size() == 1;  // because of sentinel at 0
    }
}
